      ...
      <div className="relative">
        ...
        >
          {isLoading && (
            <div
              className={cn(
                "animate-spin rounded-full h-4 w-4 border-2 border-gray-300 border-t-blue-700"
              )}
            />
          )}
          ...
          {searchTerm && !isLoading && (
            <Button
              ...
              variant="ghost"
              className={cn(
                "h-fit w-fit cursor-pointer rounded-sm p-0.5 hover:bg-gray-200 text-gray-600 transition-colors",
